...
with tab2:
    ...
    # =========================================================
    st.markdown("---")
    st.subheader("🧪 Test History Analysis")
    ...
    if not athlete_tests.empty:
        ...
        for col in numeric_cols:
            ...
            athlete_tests[col] = pd.to_numeric(
                athlete_tests[col],
                errors='coerce'
            )
        ...
        # Show raw table
        st.markdown("### 📋 Test History Table")
        ...
        # STRENGTH EVOLUTION
        # =====================================================
        st.markdown("### 📈 Strength Evolution")

        strength_df = athlete_tests.dropna(
            subset=['Left Strength', 'Right Strength']
        )
        ...
        if not strength_df.empty:
            ...
            fig_strength = px.line(
                strength_df,
                x='Date',
                y=['Left Strength', 'Right Strength'],
                color_discrete_sequence=['blue', 'red'],
                markers=True,
                hover_data=['Exercise name']
            )
